...
from chiptune_agent_kit.analysis.triangle_patterns import (
    ...
    scan_triangle_corpus,
)


def main() -> None:
    parser = argparse.ArgumentParser(
        description="Scan NES-MDB for exploratory Triangle bass pattern candidates."
    )
    ...
    args.markdown_output.write_text(render_triangle_markdown(report), encoding="utf-8")
